...
void GameItem::paint()
{
    ...
    //std::cout<<g_size.width()<<endl<<g_size.height()<<endl;
    //std::cout<<pos.x<<endl<<pos.y<<endl;
    //std::cout<<g_worldsize.width()<<endl<<g_worldsize.height()<<endl;
    //std::cout<<g_windowsize.width()<<endl<<g_windowsize.height()<<endl;
    //std::cout<<W_WORLD<<endl<<H_WORLD<<endl<<W_WINDOW<<endl<<H_WINDOW<<endl;
